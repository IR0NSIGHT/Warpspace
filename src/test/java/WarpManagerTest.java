...
public class WarpManagerTest {
    ...
    public void preciseDroppoint() {
        ...
        Vector3i warpPos = manager.getWarpSpacePos(trueRspSector);
    ...
    public void sectorCalculation() {
        ...
        Vector3i warpPos = WarpManager.getInstance().getWarpSpacePos(rspPos);
    ...
    public void idkDude() {
        ...
        System.out.println("warp " + WarpManager.getInstance().getWarpSpacePos(rspPos));
    ...
    public void stellarPos() {
        ...
        assertEquals(new Vector3f(105,105,105), p.getPositionAdjustedFor(mySector));
